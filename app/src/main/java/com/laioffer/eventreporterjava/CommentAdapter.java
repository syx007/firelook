...
public class CommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    private void configureEventView(final CommentViewHolder viewHolder, int position) {
        int pos = position - 1;
        Comment commment = commentList.get(pos);
        viewHolder.commentUser.setText(commment.getCommenter());
        viewHolder.commentDescription.setText(commment.getDescription());
        viewHolder.commentTime.setText(Utils.timeTransformer(commment.getTime()));
